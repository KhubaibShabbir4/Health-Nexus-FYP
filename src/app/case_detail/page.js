...
import Header from '../Header/page'; // Import the Header component correctly
...
export default function CaseDetail() {
  ...
  const handleStatusChange = async (status) => {
    ...
    const prescribedMedicine = prescribedMedicines.map((medicine) => medicine.split(' - ')[0]).join(', ');
    const dosage = prescribedMedicines.map((medicine) => medicine.split(' - ')[1]).join(', ');
        ...
        <div className="reportSection">
          ...
          <div className="informationSection">
            ...
            <ul>
              ...
              <li>
                <strong>Symptoms:</strong> Chest pain, shortness of breath, fatigue
              </li>
              <li>
                <strong>Date of Diagnosis:</strong> October 15, 2024
              </li>
              <li>
                <strong>Prescribed Treatment:</strong> Coronary Artery Bypass Grafting
                (CABG) Surgery
              </li>
            </ul>
          </div>
          ...
          <div className="informationSection">
            ...
            <ul>
              <li>
                <strong>Treatment Required:</strong> Surgical intervention to improve
                blood flow to the heart
              </li>
              <li>
                <strong>Expected Duration of Treatment:</strong> 1 month, including
                post-operative care
              </li>
              <li>
