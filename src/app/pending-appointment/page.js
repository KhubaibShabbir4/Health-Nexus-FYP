          ...
          {selectedAppointmentId ? (
            <div className="appointment-details">
              <div className="appointment-info">
                <p><strong>Patient Name:</strong> {appointments[selectedAppointmentId].patientName}</p>
                <p><strong>Appointment ID:</strong> {appointments[selectedAppointmentId].appointmentId}</p>
                <p><strong>Appointment Date:</strong> {appointments[selectedAppointmentId].appointmentDate}</p>
                <p><strong>Appointment Time:</strong> {appointments[selectedAppointmentId].appointmentTime}</p>
              </div>
           ...
           <button
              ...
              >
                {acceptedAppointments.includes(selectedAppointmentId) ? 'Accepted' : 'Accept'}
              </button>
        </div>
      </main>
    </div>
