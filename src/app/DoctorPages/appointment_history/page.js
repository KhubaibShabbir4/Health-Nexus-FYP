...
const AppointmentHistory = () => {
  ...
  const handleIssuePrescription = (appointmentId) => {
    router.push(`/DoctorPages/issue-prescription?appointment_id=${appointmentId}`);
  };
            ...
            <div key={appt.id} className="border-b py-4">
              ...
              <div className="mt-3 flex space-x-3">
                ...
                <button
                  ...
                  onClick={() => handleIssuePrescription(appt.id)}
                >
                  {appt.status === "completed" ? "Issue Prescription" : "View/Edit Prescription"}
                </button>
              </div>
            </div>
          ))}
