...
export default function AlKhidmatPage() {
  const [hoverIndex, setHoverIndex] = useState(null); // Tracks which box is being hovered
    ...
    <div className="ngo-board">
      ...
      <main style={{ textAlign: 'center', padding: '120px 20px 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          <h2 className="animated-text" style={{ fontSize: '3em', fontWeight: 'bold' }}>Al-Khidmat Foundation</h2>
          <Image 
        ...
        {/* Equal-Sized Boxes with Hover Effect */}
        <div
          style={{
            display: 'flex',
            ...
            <Link href={item.href} key={index}>
              <div
                ...
                style={{
                  ...
                  height: hoverIndex === index ? '290px' : '300px', // Slightly reduce height on hover
                  textAlign: 'center',
                  ...
                  transform: hoverIndex === index ? 'scale(1.02)' : 'none', // Slight scaling on hover
                }}
              >
                <h3
                  style={{
