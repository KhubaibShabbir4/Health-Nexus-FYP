...
export default async function handler(req, res) {
  try {
    ...
    const { firstName, lastName, dob, email, password, specialization, licenseNumber, experience } = req.body;
    ...
    if (existingLicense) {
      return res.status(400).json({ error: "License number already exists. Please check your details." });
    }
